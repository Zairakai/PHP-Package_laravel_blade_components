# BATS Tests — laravel-blade-components
...
├── unit/
│   └── package-structure.bats  # Package metadata and file structure (39 tests)
├── integration/
...
### Unit — `package-structure.bats` (39 tests)

Validates package metadata, directory structure, source files, Blade views (content/form/layout/medias),
translation files (21 locales), tests directory, and CI/tooling config files.
